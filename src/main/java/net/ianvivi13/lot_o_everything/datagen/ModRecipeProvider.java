...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        oreSmelting(pRecipeOutput, List.of(ModItems.RAW_SILVER.get()), RecipeCategory.MISC, ModItems.SILVER_INGOT.get(), 0.7F, 200, "silver_ingot");
        oreBlasting(pRecipeOutput, List.of(ModItems.RAW_SILVER.get()), RecipeCategory.MISC, ModItems.SILVER_INGOT.get(), 0.7F, 100, "silver_ingot");
